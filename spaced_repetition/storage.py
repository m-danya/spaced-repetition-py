...
class Card:
    ...
    def recalculate_next_date(self):
        ...
        self.data['date_next'] = self.data['date_wrong']  + timedelta(days=add_days)
...
class CardsStorage:
    ...
    def add_card_from_dict(self, d):
        self.all_cards.append(Card(d))
        self.save_to_file()
    ...
    def load_from_file(self):
        ...
        for c in cards_loaded:
            ...
            if card.is_for_today():
                self.today_cards_indexes.append(len(self.all_cards) - 1) # save index of this card
